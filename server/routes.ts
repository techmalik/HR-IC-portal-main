...
export async function registerRoutes(
  ...
  // Overtime requests → server/routes/overtime.ts
  // OOO approved-dates → server/routes/ooo.ts
  ...
  // Contract routes → server/routes/contracts.ts
  // Expense routes → server/routes/expenses.ts
